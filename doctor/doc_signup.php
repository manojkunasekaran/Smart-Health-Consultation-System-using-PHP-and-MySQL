...
<html>
<head>
        <title>Doctor Sign up | Health Consultancy Service </title>
        <meta charset="UTF-8">
        ...
        <div class="container">
            ...
            <div class="row">
                    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
                        <h1 style = "color : skyblue;">DOCTOR PERSONAL SIGNUP</h1><hr>
                        <form method="POST" action="doc_signup_sub.php">
                            NAME:
                            ...
                            QUALIFICATION:
                            <div class="form-group">
                                <input type="text" placeholder="Qualification" name="dquali"  required = "true">
                            </div>

                            EXPERIENCE:
                            <div class="form-group">
                                <input type="text" placeholder="Experience Gained" name="dexp"  required = "true">
                            </div>

                            AGE:
                            <div class="form-group">
                                <input type="text" placeholder="Age " name="dage"  required = "true">
                            </div>
                            ...
                            CITY:
                            <div class="form-group">
                                <input type="text"  placeholder="City" name="dcity" required = "true">
                            </div>

                            ADDRESS:
                            <div class="form-group">
                                <input type="text"  placeholder="Address" name="daddress" required = "true">
                            </div>
